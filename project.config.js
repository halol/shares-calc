...
module.exports = {
  ...
  ci: {
    development: {
      firebase: {
        apiKey: 'AIzaSyDtoZdnQu-mB98DHjMSQdoxjT9dVaTQ5UQ',
        authDomain: 'share-calc.firebaseapp.com',
        databaseURL: 'https://share-calc.firebaseio.com',
        storageBucket: 'share-calc.appspot.com'
      },
      reduxFirebase: {
